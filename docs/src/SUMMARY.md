...
- [ADR Index](./adr/index.md)
  ...
  - [ADR-003: Semantic Versioning with git-cliff](./adr/003-semantic-versioning.md)
  ...
  - [ADR-006: Release-Please (Superseded)](./adr/006-release-please-versioning.md)
  - [ADR-007: Separate Chart-Testing Configs](./adr/007-separate-ct-configs.md)
  - [ADR-008: Repository Dispatch Automation](./adr/008-repository-dispatch-automation.md)
  - [ADR-009: Trust-Based Auto-Merge](./adr/009-integration-auto-merge.md)
...
- [Atomization Model](./contributing/atomization.md)
